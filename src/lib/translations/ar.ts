...
export const ar = {
  ...
  quran: {
    ...
    tafsir: 'التفسير',
    tafsirByAyah: 'آية بآية',
    tafsirWholeSurah: 'السورة كاملة',
    tafsirSource: 'مصدر التفسير',
    tafsirLanguage: 'لغة التفسير',
    noTafsirInYourLanguage: 'لا يوجد تفسير معتمد بلغتك، يمكنك اختيار التفسير العربي أو الإنجليزي.',
    showArabicTafsir: 'عرض التفسير بالعربية',
    showEnglishTafsir: 'عرض التفسير بالإنجليزية',
    loadingTafsir: 'جاري تحميل التفسير...',
    tafsirError: 'تعذر تحميل التفسير',
    tapAyahForTafsir: 'اضغط على الآية لعرض تفسيرها',
