...
export const ko: TranslationKeys = {
  ...
  quran: { title: '거룩한 꾸란', searchPlaceholder: '수라 또는 구절 검색...', bookmarks: '북마크', lastRead: '마지막 읽은 곳', comingSoon: '곧 출시', contentComingSoon: '꾸란 내용이 여기에 추가됩니다', collections: '컬렉션', selectCollection: '컬렉션 선택', sections: '장', selectSection: '장 선택', hadithNumber: '하디스 번호', arabicText: '아랍어 본문', translation: '번역', loadingHadiths: '하디스 로딩 중...', errorLoading: '로딩 중 오류', noHadiths: '이 장에 하디스가 없습니다', totalHadiths: '총 하디스', allCollections: '모든 컬렉션', backToCollections: '컬렉션으로 돌아가기', backToSections: '장으로 돌아가기' },
